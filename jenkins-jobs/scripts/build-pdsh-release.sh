...
srpm_download_url="https://ftp.riken.jp/Linux/fedora/epel/8/Everything/SRPMS/Packages/p"
...
pkgs+=(libgenders-devel  perl-generators readline-devel)
...
rpmbuild --define "_topdir $top_dir" \
       	-ba ${build_options} SPECS/${spec_file}
...
echo "Finish build $build_id. original version: $version, new version: ${version/el8/${dist}}"
